...
def get_loader(data, data_path, batch_size, args):
    ...
    # print('Only using a small part data !')
    ...
    # return train_loader, test_data, test_loader, test_onehot, test_label
    ####### modify for fair tesst #######
    return train_loader, train_set, test_loader, test_onehot, test_label
